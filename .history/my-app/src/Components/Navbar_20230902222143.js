...
function NavBar() {
  return (
    <Box>
        ...
        <Box display={{ base: 'block', lg: 'none' }} backgroundColor='blues.100'>
            <Button leftIcon={<img src={`${process.env.PUBLIC_URL}/icons8-menu.png`} alt="Menu Icon" />} backgroundColor='blues.200'/>
        </Box>
    </Box>
    );
}
